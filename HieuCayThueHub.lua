...
shared.LoaderTitle = "Đăng Ký Kênh Cờ Mờ Hờ
(cày thuê)";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://136268929758409",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Youtube: Cờ Mờ Hờ(cày thuê)",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=136268929758409";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://zalo.me/g/iwdlce537");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://136268929758409") then
                    return v729;
                end
            end
        end
